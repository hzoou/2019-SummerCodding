	...
	<form action="register" method="POST" onSubmit="return reg_click()">
			<table class="content">
				<tr>
					...
					<td><input type="text" name="title" placeholder="ex) 서머코딩 2차 과제" onkeyup="length_check(this, 100);"/></td>
				</tr>
				<tr>
					<td valign="top"><label style="color: #c00">*&nbsp;</label><label>내용을 입력하세요 : </label></td>
					<td><textarea id="content" name="content" placeholder="ex) 새로운 TODO 등록 구현" onkeyup="length_check(this, 255);"></textarea></td>
